...
export default function CoachReview({ review, onClose }: CoachReviewProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/25 animate-fade-in">
      <div className="w-full max-w-sm bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl border border-gray-100 max-h-[85vh] flex flex-col">
        {/* Scrollable content */}
        <div className="overflow-y-auto flex-1 p-8 pb-4 space-y-5">
          {/* Header */}
